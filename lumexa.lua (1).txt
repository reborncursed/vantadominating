...
local MobileButtonIcon = "rbxassetid://75799771878613"
local MobileButtonThumb = "rbxthumb://type=Asset&id=75799771878613&w=420&h=420"
...
task.spawn(function()
  local function applyMobileIcon(target)
    ...
    target:SetAttribute("LumexaMinimizer", true)
    target.Visible = true
  ...
  local function ensureOverlay()
    local overlay = MobileButton:FindFirstChild("LumexaIcon")
    if not overlay then
